module Test.Number.Format.Maybe (tests) where

import Data.Maybe
import Number.Format.Maybe
import Test.Unit
...
tests = do
  ...
  test "Number.Format.Maybe.toExponential" do
    test "formatting" do
  ...
  test "Number.Format.Maybe.toFixed" do
    test "formatting" do
  ...
  test "Number.Format.Maybe.toPrecision" do
    test "formatting" do
  ...
  test "Number.Format.Maybe.toString" do
    test "formatting" do
